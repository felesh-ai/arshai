...
test_env_path = Path(__file__).parent / ".env.openai"
...
def openai_client(openai_config):
    """Create OpenAI client for testing - shared across all tests"""
...
class TestOpenAIClient:
    """Test class for OpenAI client with shared client instance"""
    ...
    def test_client_initialization(self, client):
        """Test that the OpenAI client initializes correctly"""
...
# Or run specific test: python -m pytest tests/unit/llms/test_azure_unified.py::TestOpenAIClient::test_simple_chat -v
